...
#     path('reset/',auth_views.PasswordResetView.as_view(template_name='password_reset.html',email_template_name='password_reset_email.html',subject_template_name='password_reset_subject.html'),name='password_reset'),
...
#     path('boards/<int:pk>/topics/<int:user_id>/', views.topic_posts, name='topic_posts'),
#     url('boards/<int:pk>/topics/<int:user_id>/reply/', views.reply_topic, name='reply_topic'),
